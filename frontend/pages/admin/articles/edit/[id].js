...
import { getArticle, updateArticle, getCategories, getTags } from '../../../../utils/api';
...
export default function EditArticle() {
    ...
    const fetchData = async () => {
      try {
        ...
        setFormData({
          ...
          access_tier: articleData.access_tier,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError('Failed to update article. Please check your inputs and try again.');
      setSubmitting(false);
    }
  };
